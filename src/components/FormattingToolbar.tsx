...
const TOOL_BTN =
  'flex flex-col items-center justify-center gap-[3px] px-[11px] py-[7px] rounded-md min-w-[52px] ' +
  'transition-all duration-150 ' +
  'text-[var(--text-secondary)] hover:text-[var(--accent)] hover:bg-[rgba(99,102,241,0.07)] ' +
  'disabled:opacity-30 disabled:cursor-not-allowed disabled:hover:bg-transparent disabled:hover:text-[var(--text-secondary)]';

const TOOL_LABEL = 'text-[9px] font-semibold whitespace-nowrap leading-none tracking-[0.07em] uppercase';
...
export default function FormattingToolbar({
  ...
  return (
    <div
      ...
      className="hidden sm:block transition-opacity duration-150"
      style={{
    ...
    >
    <div className="max-w-3xl mx-auto flex justify-center items-stretch px-3 sm:px-12">
      {/* Bold */}
      <button
        type="button"
      ...
      <div ref={linkRef} className="relative flex">
        <button
          ...
          aria-label="Link"
          title="Insert link"
          className={`${TOOL_BTN} ${linkOpen ? '!text-[var(--accent)] !bg-[rgba(99,102,241,0.12)]' : ''}`}
        >
          <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      ...
      <div ref={tableRef} className="relative flex">
        <button
          ...
          title="Insert table"
          className={`${TOOL_BTN} ${tableOpen ? '!text-[var(--accent)] !bg-[rgba(99,102,241,0.12)]' : ''}`}
        >
          <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
